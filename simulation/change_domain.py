...
length_base_ratio = 10  # Ratio of length and base of the domain.
...
if mesh == "porous":
    os.system(f"$BLENDER_PATH --background --python ../mesh-generators/generate_porous_mesh.py -- \
    ...
    os.system(f"$BLENDER_PATH --background --python ../mesh-generators/generate_wire_mesh.py -- \
               --export_path {filename}                \
